...
## Arcana
It would be real neat if GWDG enabled models called through CoCoAI / SAIA to use [Arcana](https://chat-ai.academiccloud.de/arcanas/) / RAG. This would allow me to park documentation for commonly used libraries in an Arcana, so that the coding agent can use them.
