---
modified:
  - 2026-04-20T09:53:00+02:00
created: 2026-04-20T09:52:07+02:00
author:
  - Michael E. Shea
source: https://slyflourish.com/
...
- [The Eight Steps of Lazy RPG Prep](https://slyflourish.com/lazy_gm_resource_document.html#eightsteps)
- [The Lazy RPG Preparation Process](https://slyflourish.com/lazy_gm_resource_document.html#prepprocess)
- [Example Strong Starts](https://slyflourish.com/lazy_gm_resource_document.html#strongstarts)
- [Creating Secrets and Clues](https://slyflourish.com/lazy_gm_resource_document.html#creatingsecrets)
- [Building an RPG Group](https://slyflourish.com/lazy_gm_resource_document.html#buildingagroup)
- [Session Zero Checklist](https://slyflourish.com/lazy_gm_resource_document.html#sessionzerochecklist)
- [Safety Tools](https://slyflourish.com/lazy_gm_resource_document.html#safetytools)
- [Connecting Characters](https://slyflourish.com/lazy_gm_resource_document.html#connectingcharacters)
- [Spiral Campaign Development](https://slyflourish.com/lazy_gm_resource_document.html#spiralcampaigns)
- [Quest Templates](https://slyflourish.com/lazy_gm_resource_document.html#questtemplates)
- [Tools for 5e Improvisation](https://slyflourish.com/lazy_gm_resource_document.html#toolsforimprov)
- [Quick Tricks for Lazier 5e Games](https://slyflourish.com/lazy_gm_resource_document.html#quicktricks)
- [5e Quick Encounter Building](https://slyflourish.com/lazy_gm_resource_document.html#quickencounterbuilding)
- [Lazy Combat Encounter Building for 5e](https://slyflourish.com/lazy_gm_resource_document.html#lazycombatencounterbuilding)
- [Theater of the Mind Guidelines (Extended)](https://slyflourish.com/lazy_gm_resource_document.html#totmguidelines1)
- [Theater of the Mind Guidelines (Abbreviated)](https://slyflourish.com/lazy_gm_resource_document.html#totm2)
- [Zone-Based Combat](https://slyflourish.com/lazy_gm_resource_document.html#zonebasedcombat)
- [Monster Difficulty Dials](https://slyflourish.com/lazy_gm_resource_document.html#monsterdifficultydials)
- [Monster Templates](https://slyflourish.com/lazy_gm_resource_document.html#monstertemplates)
- [Undead Templates](https://slyflourish.com/lazy_gm_resource_document.html#undeadtemplates)
- [Running Hordes](https://slyflourish.com/lazy_gm_resource_document.html#runninghordes)
- [Stress Effects](https://slyflourish.com/lazy_gm_resource_document.html#stresseffects)
- [Core Adventure Generators](https://slyflourish.com/lazy_gm_resource_document.html#coreadventuregenerators)
- [NPC Generator](https://slyflourish.com/lazy_gm_resource_document.html#npcgenerator)
- [Treasure Generator](https://slyflourish.com/lazy_gm_resource_document.html#treasuregenerator)
- [Random Traps](https://slyflourish.com/lazy_gm_resource_document.html#randomtraps)
- [Random Monuments](https://slyflourish.com/lazy_gm_resource_document.html#randommonuments)
- [Wilderness Travel and Exploration](https://slyflourish.com/lazy_gm_resource_document.html#wildernesstravel)
- [Random Chambers](https://slyflourish.com/lazy_gm_resource_document.html#randomchambers)
- [Random Underground Connectors](https://slyflourish.com/lazy_gm_resource_document.html#randomconnectors)
- [Random Items](https://slyflourish.com/lazy_gm_resource_document.html#randomitems)
- [Random Town Events](https://slyflourish.com/lazy_gm_resource_document.html#randomtownevents)
- [Random Dungeon Monsters](https://slyflourish.com/lazy_gm_resource_document.html#randomdungeonmonsters)
- [Lazy Solo 5e](https://slyflourish.com/lazy_gm_resource_document.html#lazysolo5e)
- [The Village of Whitesparrow](https://slyflourish.com/lazy_gm_resource_document.html#villageofwhitesparrow)
- [The Night Blade](https://slyflourish.com/lazy_gm_resource_document.html#thenightblade)
...
Last Names/Organization Names: Lionstone, Treeson, Oakhelm, Gentleheart, Whitesong, Starharp, Nightchaser, Shadowstinger, Catclaw, Faeriebound, Leafwing, Goldrock, Darkslicer, Gravewalker, Rainbright, Needleflinger, Goosechaser, Steelclaw, Scalerazor, Glasscutter, Ironhouse, Eboncloud. More names can be found in the "[NPC Generator](https://slyflourish.com/lazy_gm_resource_document.html#npcgenerator)" section later in this document.
...
Before the number of monsters is set, you can gauge whether your intended encounter is deadly or not by using the "[5e Quick Encounter Building](https://slyflourish.com/lazy_gm_resource_document.html#quickencounterbuilding)" section of this document.
...
First, build a quest-giving NPC by rolling for behavior and ancestry in the "[Core Adventure Generators](https://slyflourish.com/lazy_gm_resource_document.html#coreadventuregenerators)" section of this document. Choose a name and any other details from the "[NPC Generator](https://slyflourish.com/lazy_gm_resource_document.html#npcgenerator)" section.

Next, roll on the Quests in "[Core Adventure Generators](https://slyflourish.com/lazy_gm_resource_document.html#coreadventuregenerators)". Determine the location by rolling on the Condition, Description, Origin, and Location table.
...
You can then fill in additional quest details from the other tables in "[Core Adventure Generators](https://slyflourish.com/lazy_gm_resource_document.html#coreadventuregenerators)". Examples include required keys, monuments, villains, lieutenants, and other quest goals.
...
Roll for the trap type on the Traps and Hazards table in the "[Core Adventure Generators](https://slyflourish.com/lazy_gm_resource_document.html#coreadventuregenerators)" section. Then make a DC 12 Wisdom (Perception) check to locate the trap or hazard. Roll the most applicable ability check or saving throw vs DC 12 to avoid the trap or hazard. Failure on either roll results in 1d6 damage per character level of a type appropriate for the trap.

### Monster Encounter

Roll for a random monster on the Monster table in the "[Random Dungeon Monsters](https://slyflourish.com/lazy_gm_resource_document.html#randomdungeonmonsters)" section, selecting a dungeon level equal to your character level.
...
Each monster encounter includes a helpful, neutral, or harmful monument. Generate monuments using the Locations, Monuments, and Items table, and the Condition, Description, and Origin table in the "[Core Adventure Generators](https://slyflourish.com/lazy_gm_resource_document.html#coreadventuregenerators)" section.
...
For consumable and permanent items, roll on the tables in the "[Treasure Generator](https://slyflourish.com/lazy_gm_resource_document.html#treasuregenerator)" section or a random treasure table of your choice. You can replace any consumable magic item with a _potion of healing_. You can replace any permanent magic item with a _+1 weapon_ of your choice.

