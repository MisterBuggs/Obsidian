...
- Adventure sites
    ...
    Plan for about eight to twelve short dungeons with five rooms each, two or three medium locations, and maybe one large dungeon that links different areas. Use the [World Wiki](https://www.westmarches.games/guide/world-wiki) to keep track of locations, rumors, and lore.
...
- Hex crawl (optional)
    ...
    Set up the map using three-mile hexes. The GM keeps a detailed map, while players explore and fill in their own blank map. WestMarches.games has a built-in [hexcrawl map tool](https://www.westmarches.games/guide/hexcrawl) for making interactive hex maps.
...
Start small and share information often. The campaign gets better once players start driving the action themselves - picking where to go, following up on rumors, and arguing about what to explore next.

## Guides

[Overview](https://www.westmarches.games/guide)[What is West Marches](https://www.westmarches.games/guide/what-is-west-marches)[Running West Marches](https://www.westmarches.games/guide/running-west-marches)[Player Characters](https://www.westmarches.games/guide/player-characters)[Adventures](https://www.westmarches.games/guide/adventures)

## Features

[World Wiki](https://www.westmarches.games/guide/world-wiki)[Hexcrawl Maps](https://www.westmarches.games/guide/hexcrawl)[Currencies](https://www.westmarches.games/guide/currencies)[Resources](https://www.westmarches.games/guide/resources)