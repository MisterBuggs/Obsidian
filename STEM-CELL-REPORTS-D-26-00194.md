...
10. Visualization: I appreciate that the authors consequently overlaid single points. Displaying results as box plots with single point overlay may be even more appropriate than "dynamite plunger" plots with mean +/- SEM. 
11. 
Language & Proofing:
12. Continuous line numbers are appreciated  during the review process.
13. Quantification and statistical analysis, line 5: There is a period after the +/- sign. 
14. Page 12, line 4: Spelling. 
15. Page 13, "independent of sex and of body weight": "~~of~~" -> "and".
16. Page 13, "infection and infiltrated into the respiratory": "~~infiltrated~~" -> "infiltrate"?
Further Suggestions & Future Directions:
17. Figure 3: While not statistically significant per line, there seems to be a trend towards lesser peripheral blood cell concentrations, which the authors may consider mentioning in the respective results subsection.
18. Consider supplementing this study with CFC assays of fetal liver and bone marrow-derived HSPC.
19. Analyzing elderly mice exposed in utero and analyzing the first & second generation off-spring of mice exposed in utero would be highly interesting to capture the scope and persistence of epigenetic changes introduced by perinatal nicotine exposure. In addition, exposing dams before but not during pregnancy or only after birth but while breast feeding may be interesting. 
20. Page 8, 9: Consider analyzing which cells in the liver were responsible for the altered niche signaling, i.e., which cells produced these cytokines, e.g., by intracellular flow cytometry or, as a proxy, by transcriptomics. 
21. Consider sequencing the bone marrow of in utero exposed off-spring, searching for typical, clonal hematopoiesis-associated mutations, which may explain some of the effects observed in this study.
